...
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `AGENTS.md`, the gate count             | "three gates" until 2026-09-05, wrong since 2026-09-03. Then "five" for a day. Then seven, nine, ten, **twelve** — each correction dated, with the branch that caused the drift named. **Thirteen** on 2026-09-17 (#201) and **fourteen** on 2026-09-18 (#187), and this time the prose did not follow: `master` ran thirteen while `AGENTS.md`, `docs/status.md` and the `justfile` header all still said twelve. **Fifteen** on 2026-09-20 (#233, `verify-doc-counts`) — the first correction a gate enforces on itself: `count:verify-gates` reads the `verify:` recipe directly, so a prose count left behind now fails the build instead of just being wrong. |
